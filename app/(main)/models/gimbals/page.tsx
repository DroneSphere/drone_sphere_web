...
import AddGimbalDialog from "./add-dialog";
...
export default function Page() {
  ...
  const filteredData = useMemo(() => {
    ...
    return (query.data || []).filter((item) => {
      return (
        String(item.gimbal_model_id).includes(lowercaseSearch) ||
        (item.gimbal_model_name || "")
          .toLowerCase()
          .includes(lowercaseSearch) ||
        (item.gimbal_model_product || "")
          .toLowerCase()
          .includes(lowercaseSearch) ||
        (item.gimbal_model_description || "")
          .toLowerCase()
          .includes(lowercaseSearch)
      );
    });
